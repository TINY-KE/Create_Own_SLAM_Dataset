...
// #include <gazebo/transport/transport.h>
// #include <gazebo/physics/physics.h>
// #include <gazebo/common/common.h>
// #include <gazebo/rendering/rendering.h>
// #include <gazebo/sensors/sensors.h>
// // #include <gazebo/math/gzmathc.h>
// // #include <gazebo/gui/gui.h>
// #include <ignition/math/Vector3.h>
...
{   std::string worldfile;
    ...
    gazebo::physics::WorldPtr world = gazebo::loadWorld("/home/lj/Documents/codes/galbot_ws/src/sim_env/world/room_with_objects_on_ground.world");//worlds/empty.world
    ...
    for (auto model : models) {
            ...
            {   
                ...
                // auto collision = collisions[0];   
                {
                    ...
                    auto box = collision->BoundingBox();

                    // // Assuming Vector3d is the type of minimum and maximum points in AxisAlignedBox
                    // ignition::math::v6::AxisAlignedBox axisAlignedBox = collision->BoundingBox();
                    // // Explicitly construct ignition::math::Box using the types from AxisAlignedBox
                    // ignition::math::Box<double> box(axisAlignedBox.Min(), axisAlignedBox.Max());
